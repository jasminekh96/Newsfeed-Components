...
// FOREACH GOES HERE looping through our data to create multiple card components and appending to the container
data.forEach((data) => {
	console.log('creating panel:', data.title);
	container.appendChild(
		createCard(data.title, data.date, data.firstParagraph, data.secondParagraph, data.thirdParagraph),
	);
});
...
function createCard(title, date, firstParagraph, secondParagraph, thirdParagraph) {
	...
	card.appendChild(cardThird);
	card.appendChild(buttonOpen);

	//set class names
	card.classList.add('article');
	cardDate.classList.add('date');
	cardFirst.classList.add('p');
	cardSecond.classList.add('p');
	cardThird.classList.add('p');
	...
	buttonOpen.textContent = 'Expand Button';
